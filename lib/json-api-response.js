...
var jar = function(){
     ...
     * @returns {*}
     */
    self.error = function(code, type, message) {
        var obj = {};
        obj.error = {};
    ...
    self.response = function ( obj ) {
        if( (typeof obj == "object") ){
            ...
            return self.error( self.errorCode, self.lang.ErrorExceptionTitle, self.lang.ErrorExceptionText);
        }
    }
